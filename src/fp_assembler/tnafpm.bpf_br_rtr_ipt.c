...
static __always_inline int tnartr(struct __sk_buff *skb, struct tna_meta_t* tna_meta)
{
        int rc;
        ...
        //{% endif %}
                ...
                bpf_ipt_lookup(skb, &tna_meta->ipt_params, sizeof(struct bpf_ipt_lookup), tna_meta->iph);
